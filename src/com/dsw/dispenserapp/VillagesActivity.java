...
public class VillagesActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstance){
		...
		setContentView(R.layout.villages);
	}
	...
	protected void onResume(){
		...
		TextView viewHeader = (TextView) findViewById(R.id.txtAllVillages);
		viewHeader.setText(sublocation + ": Villages");
		
		listView = (ListView) findViewById(R.id.listVillages);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				Intent in = new Intent(getApplicationContext(), WaterpointsActivity.class);
