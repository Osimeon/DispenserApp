...
public class PrototypeDistrictsActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstance){
		...
		setContentView(R.layout.prototype_districts);
	}
	...
	protected void onResume(){
		...
		listView = (ListView) findViewById(R.id.listDistrictsPrototype);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				Intent in = new Intent(getApplicationContext(), PrototypeSublocationsActivity.class);
