...
public class SublocationsActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstance){
		...
		setContentView(R.layout.sublocations);
	}
	...
	protected void onResume(){
		...
		TextView viewHeader = (TextView) findViewById(R.id.txtAllSublocations);
		viewHeader.setText(dist + ": Sublocations");
		
		listView = (ListView) findViewById(R.id.listSublocations);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				Intent in = new Intent(getApplicationContext(), VillagesActivity.class);
